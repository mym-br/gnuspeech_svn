...
#ifdef i386
	NXRunAlertPanel("TTS Developer Upgrade",
                                "This upgrade only works with NeXT hardware.  Please contact Trillium Sound Research.",
                                "Ok", NULL, NULL);
	exit(0);
#endif
...
unsigned int seed;
	...
	if (fp == NULL)
	{
		NXRunAlertPanel("TTS Developer Upgrade",
				...
				"Ok", NULL, NULL, appPath);
		return self;
	}

	myPipe = popen("/usr/ucb/zcat | (cd /; /NextAdmin/Installer.app/installer_bigtar -xf -)", "w");
	if (myPipe == NULL)
	{
		NXRunAlertPanel("TTS Developer Upgrade",
				"Cannot create pipe.",
