...
static void write_table_to_page()
{
    ...
    *(page_index++) = DSPFloatToFix24(amplitude(parameter[0].value));
    
    /*  MASTER VOLUME  */
    *(page_index++) = DSPFloatToFix24(amplitude(parameter[17].value));
    
    /*  ASPIRATION VOLUME  */
    *(page_index++) = DSPFloatToFix24(amplitude(parameter[2].value));
    
    /*  FRICATION VOLUME  */
    *(page_index++) = DSPFloatToFix24(amplitude(parameter[3].value));
    
    /*  BYPASS REGISTER  */
    *(page_index++) = DSPIntToFix24(nnint(parameter[19].value));
    ...
    *(page_index++) = DSPFloatToFix24(parameter[6].value);
    ...
    set_resonator_coefficients(parameter[9].value,parameter[10].value,&a,&b,&c);
    *(page_index++) = DSPFloatToFix24(c);
    *(page_index++) = DSPFloatToFix24(b - 1.0); 
    *(page_index++) = DSPFloatToFix24(a - 1.0);
    
    /*  R2 FREQUENCY AND BANDWIDTH  */
    set_resonator_coefficients(parameter[11].value,parameter[12].value,&a,&b,&c);
    *(page_index++) = DSPFloatToFix24(c);
    *(page_index++) = DSPFloatToFix24(b - 1.0); 
    *(page_index++) = DSPFloatToFix24(a - 1.0);
    
    /*  R3 FREQUENCY AND BANDWIDTH  */
    set_resonator_coefficients(parameter[13].value,parameter[14].value,&a,&b,&c);
    *(page_index++) = DSPFloatToFix24(c);
    *(page_index++) = DSPFloatToFix24(b - 1.0); 
    *(page_index++) = DSPFloatToFix24(a - 1.0);
    
    /*  R4 FREQUENCY AND BANDWIDTH  */
    set_resonator_coefficients(parameter[15].value,parameter[16].value,&a,&b,&c);
    *(page_index++) = DSPFloatToFix24(c);
    *(page_index++) = DSPFloatToFix24(b - 1.0); 
    *(page_index++) = DSPFloatToFix24(a - 1.0);
    
    /*  FRICATION RESONATOR FREQUENCY AND BANDWIDTH  */
    set_resonator_coefficients(parameter[4].value,parameter[5].value,&a,&b,&c);
    *(page_index++) = DSPFloatToFix24(c);
    *(page_index++) = DSPFloatToFix24(b - 1.0); 
    *(page_index++) = DSPFloatToFix24(a - 1.0);
