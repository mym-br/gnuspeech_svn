...
$Revision: 1.1 $
$Source: /Users/dalmazio/cvsroot/gnuspeech/trillium/src/SpeechObject/postMonet/objC.monet/Controller.m,v $
$State: Exp $
...
{
    tts_error_t error = [mySpeaker setOutputSampleRate:[inputField1 floatValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker setNumberChannels:[inputField1 intValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- setBalance:sender
{
    tts_error_t error = [mySpeaker setBalance:[inputField1 floatValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- setSpeed:sender
{
    tts_error_t error = [mySpeaker setSpeed:[inputField1 floatValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker setIntonation:[inputField1 intValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- setVoiceType:sender
{
    tts_error_t error = [mySpeaker setVoiceType:[inputField1 intValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker setPitchOffset:[inputField1 floatValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker setVocalTractLengthOffset:
...
{
    tts_error_t error = [mySpeaker setBreathiness:[inputField1 floatValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- setVolume:sender
{
    tts_error_t error = [mySpeaker setVolume:[inputField1 floatValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- setDictionaryOrder:sender
{
    ...
    error = [mySpeaker setDictionaryOrder:order];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
...
{
    tts_error_t error = [mySpeaker setAppDictPath:[inputField1 stringValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker setUserDictPath:[inputField1 stringValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- speakText:sender
{
    tts_error_t error = [mySpeaker speakText:[inputField1 stringValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- speakStream:sender
{
    ...
    /*  SPEAK MEMORY STREAM  */
    error = [mySpeaker speakStream:stream];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
...
{
    tts_error_t error = [mySpeaker setEscapeCharacter:*[inputField1 stringValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- setBlock:sender
{
    tts_error_t error = [mySpeaker setBlock:[inputField1 intValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker setSoftwareSynthesizer:[inputField1 intValue]];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    [outputField setIntValue:[mySpeaker softwareSynthesizer]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker pauseImmediately];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker pauseAfterCurrentUtterance];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
- continue:sender
{
    tts_error_t error = [mySpeaker continue];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker eraseAllSound];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
...
{
    tts_error_t error = [mySpeaker eraseCurrentUtterance];
    [outputField setStringValue:[mySpeaker errorMessage:error]];
    return self;
}
