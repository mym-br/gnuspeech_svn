	...
	if (ret_value == RCV_SUCCESS)
	{
		...
		switch(*temp)
		{
			...
			case SET_BALANCE: 	/* Set Balance */
				...
				break;
			case SET_BLOCK: 	/* Set Blocking */
                		set_block(&msg_header, (int)(*temp1));
				break;
			case SET_VOICE_TYPE: 	/* Set voiceType */
                		set_voice_type(&msg_header, (int)(*temp1));
				break;			
			case SET_VTL_OFFSET: 	/* Set vocal tract length offset */
                		set_vtl_offset(&msg_header, (int)(*temp1));
				break;			
			case SET_BREATHINESS: 	/* Set Breathiness */
                		set_breathiness(&msg_header, (int)(*temp1));
				break;			
			case SET_CHANNELS: 	/* Set number of channels */
                		set_channels(&msg_header, (int)(*temp1));
				break;			
			case SET_SAMPLE_RATE: 	/* Set sampling rate */
                		set_sampling_rate(&msg_header, (int)(*temp1));
				break;			
			case SET_SOFT_SYNTH: 	/* Set sampling rate */
                		set_soft_synth(&msg_header, (int)(*temp1));
				break;			
			...
			case GET_EXPIRYDATE: 	/* Get Expiry date for demo */
				...
				break;
			case GET_VOICE_TYPE: 	/* Set voiceType */
                		get_voice_type(&msg_header, (int)(*temp1));
				break;			
			case GET_VTL_OFFSET: 	/* Set vocal tract length offset */
                		get_vtl_offset(&msg_header, (int)(*temp1));
				break;			
			case GET_BREATHINESS: 	/* Set Breathiness */
                		get_breathiness(&msg_header, (int)(*temp1));
				break;			
			case GET_CHANNELS: 	/* Set number of channels */
                		get_channels(&msg_header, (int)(*temp1));
				break;			
			case GET_SAMPLE_RATE: 	/* Set sampling rate */
                		get_sampling_rate(&msg_header, (int)(*temp1));
				break;			
			case GET_SOFT_SYNTH: 	/* Set sampling rate */
                		get_soft_synth(&msg_header, (int)(*temp1));
				break;			
