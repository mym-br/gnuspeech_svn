...
//#import "TextToSpeech.h"    /* use this when hidden methods not needed  */
#import "TextToSpeechPlus.h"  /* use this when hidden methods needed  */
...
- pronunciationButton:sender
{
    ...
    pron = [mySpeaker pronunciation:[inputField stringValue]:&dict:0xdeafbabe];

    /*  DISPLAY PRONUNCIATION AND DICTIONARY FOUND IN  */
    if (strlen(pron) == 0)
	[outputField setStringValue:"Nothing entered, wrong password, or hung server."];
    else {
	sprintf(buffer,"%s  (dict = %-d)\n", pron, dict);
	[outputField setStringValue:buffer];
    }
...
- linePronunciationButton:sender
{
    ...
    /*  GET PRONUNCIATION OF LINE  */
    pron = [mySpeaker linePronunciation:[inputField stringValue]:0xdeafbabe];

    /*  DISPLAY PRONUNCIATION  */
    if (strlen(pron) == 0)
	[outputField setStringValue:"Nothing entered, wrong password, or hung server."];
    else {
	[outputField setStringValue:pron];
    }
