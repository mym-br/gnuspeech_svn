...
{
PhoneList *mainPhoneList = (PhoneList *) NXGetNamedObject("mainPhoneList", NXApp);
CategoryList *mainCategoryList = (CategoryList *) NXGetNamedObject("mainCategoryList", NXApp);
Phone *tempPhone;
int dummy;
