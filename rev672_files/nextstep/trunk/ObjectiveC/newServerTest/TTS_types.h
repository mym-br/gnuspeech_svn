...
#define TTS_ELASTICITY_DEF              0
#define TTS_ELASTICITY_VARIABLE         0
#define TTS_ELASTICITY_UNIFORM          1
...
/*  Sync Rate Definitions  */
#define TTS_SYNC_RATE_MIN               1
#define TTS_SYNC_RATE_MAX               60
#define TTS_SYNC_RATE_DEF               30


/*  TTS NXDefaults Definitions  */
#define TTS_NXDEFAULT_OWNER             "TextToSpeech"
#define TTS_NXDEFAULT_NUMBER            8
#define TTS_NXDEFAULT_SPEED             "speed"
#define TTS_NXDEFAULT_ELASTICITY        "elasticity"
...
/*  Data Structure for Sync Messages  */
typedef struct {
    short int minutes;
    short int seconds;
    short int frame_number;
} TTS_SyncMessage;


/*  Data Structure for Real-Time Messages  */
typedef struct {
    short int utterances;
    short int words;
    short int tag;
} TTS_RealTimeMessage;
