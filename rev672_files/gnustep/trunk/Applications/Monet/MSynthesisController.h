...
@class TRMSynthesizer, MMTextToPhone;
...
@interface MSynthesisController : MWindowController
{
    ...
    IBOutlet NSButton *intonationSwitch;
    IBOutlet NSTextField *tempoField;
    IBOutlet NSForm *intonParmsField;
    IBOutlet NSTextField *radiusMultiplyField;

    IBOutlet NSButton *macroIntonationSwitch;
    IBOutlet NSButton *microIntonationSwitch;
    IBOutlet NSButton *driftSwitch;
